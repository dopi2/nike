...
import banner from '../assets/NIKE-BANNERS-1920X696.jpg'
import banner2 from '../assets/JUNE-SALE-1920X696-BANNERS-1.jpg'
  ...
  return (
    <>
      <Swiper
        ...
        className="mySwiper"
      >
        <SwiperSlide style={myStyle} id='first-text'>
       <img src={banner}/></SwiperSlide>
